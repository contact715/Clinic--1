...
export const EmergencySection: React.FC = () => {
  return (
    <section className="py-20 bg-[#E30613] relative overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="text-white max-w-2xl">
          ...
          <p className="text-white/80 text-lg font-medium max-w-lg mb-8">
            Don't let a hot Valley day get worse. Our rapid response team is ready to deploy immediately.
          </p>
          <a
            href="tel:8187310445"
            className="inline-flex items-center gap-3 px-8 py-4 bg-white text-[#E30613] rounded-xl font-bold text-lg hover:bg-[#1D1D1B] hover:text-white transition-colors shadow-xl"
          >
